...
<head>
  ...
  <title>RS Pelita Insani | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/themes/adminlte/plugins/iCheck/square/blue.css">
...
<style type="text/css">
  .login-page {
    background: url("<?php echo Yii::app()->request->baseUrl; ?>/images/login-bg.jpg") no-repeat fixed center; 
  }

  .login-box {
    border: 7px solid #3bb3c2;
  }
</style>
</head>
