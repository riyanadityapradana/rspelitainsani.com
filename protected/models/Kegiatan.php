...
/**
 * This is the model class for table "t_kegiatan".
 *
 * The followings are the available columns in table 't_kegiatan':
...
class Kegiatan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_kegiatan, nama_kegiatan, tgl_mulai, tgl_selesai', 'safe', 'on'=>'search'),
		);
	}
